...
use openvm_sha2_air::{
    Sha2BlockHasherSubairConfig, Sha2DigestCols, Sha2DigestColsRef, Sha2DigestColsRefMut, Sha2RoundCols,
    Sha2RoundColsRef, Sha2RoundColsRefMut,
};
...
pub struct Sha2BlockHasherVmRoundCols<
    T,
...
#[derive(Clone, Copy, Debug, ColsRef)]
#[config(Sha2BlockHasherSubairConfig)]
pub struct Sha2BlockHasherVmDigestCols<
    T,
    const WORD_BITS: usize,
    const WORD_U8S: usize,
    const WORD_U16S: usize,
